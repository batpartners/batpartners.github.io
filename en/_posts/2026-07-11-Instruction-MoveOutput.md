...
| :--- | :--- | :--- |
| **RobTargets** | RobTarget | Motion target position. Connects to the output of the <a href="https://batpartners.github.io/en/datatype/DataType-RobTarget/" target="_blank">RobTarget</a> or <a href="https://batpartners.github.io/en/datatype/DataType-Positioner_RobTarget/" target="_blank">Positioner RobTarget</a> component. |
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>• TRUE: Apply MoveJ to the first and last targets<br>
              • FALSE: Apply the configured motion type to all targets</td>
        </tr>
        <tr>
          <td><strong>Fine Start End</strong></td>
          <td>Toggle</td>
          <td>• TRUE: Apply fine zone to the first and last targets<br>
              • FALSE: Apply the configured zone value to all targets </td>
        </tr>                
      </tbody>
    </table>
<p align="center"><img src="/assets/images/1_MoveOutput_1.png" align="center" width="45%"></p>
  </div>
</div>
