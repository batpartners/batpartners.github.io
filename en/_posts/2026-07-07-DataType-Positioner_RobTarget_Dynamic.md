...
translated: true
lang: en
permalink: /en/datatype/DataType-Positioner_RobTarget/DataType-Positioner_RobTarget_Dynamic/
translation_link: /datatype/DataType-Positioner_RobTarget/DataType-Positioner_RobTarget_Dynamic/
...
<style>
  /* 💡 [Table Width Uniformity] Forces all markdown and tab tables inside content to 100% width */
  .page__content table,
  ...
  /* 💡 [Column Ratio Uniformity] Uniformly matches all tables to 1st col(20%), 2nd col(15%), 3rd col(65%) */
  ...
  /* Smooth Fade-in Animation for Tab Transition */
  @keyframes fadeIn {
    ...
    <table class="spec-table" style="margin: 0;">
      ...
      <tbody>
        <tr>
          ...
          <td>String</td>
          <td>Defines the name of the `RobTarget` variable to be created. This variable is used as a unique identifier storing the robot's target position and orientation.</td>
        </tr>
      </tbody>
    </table>
  </div>
    ...
    <table class="spec-table" style="margin: 0 0 20px 0;">
      ...
      <tbody>
        <tr>
          ...
          <td>String</td>
          <td>Extracts and outputs the data corresponding to the first index within each branch of the input data `TargetPlane`.</td>
        </tr>
        <tr>
          <td><strong>Split End</strong></td>
          <td>String</td>
          <td>Extracts and outputs the data corresponding to the last index within each branch of the input data `TargetPlane`.</td>
        </tr>
      </tbody>
    </table>
