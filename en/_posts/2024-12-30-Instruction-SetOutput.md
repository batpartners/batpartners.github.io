...
translated: true
lang: en
permalink: /en/instruction/Instruction-SetOutput/

translation_link: /instruction/Instruction-SetOutput/
sidebar:
  nav: "sidebar"
toc: true
toc_label: "Contents"
...
<div class="tabs-container">
  ...
  <ul class="tab-buttons">
    <li><label for="tab1">SetOutput</label></li>
  </ul>
  <div class="tab-content" id="content1">
    <table class="spec-table">
      ...
      <tbody>
        <tr>
          <td><strong>Signal Typ</strong></td>
          <td>Toggle</td>
