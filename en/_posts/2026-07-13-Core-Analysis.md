...
layout: single
header:
  teaser: "/assets/images/3_AnalysisDeconstructor.png"
...
This is a component that outputs the code information generated by the Core component as a text log, including the robot axis angle values, the error index, and the error reason.
...
| **Error Report** | String | Row-by-row error type analysis |