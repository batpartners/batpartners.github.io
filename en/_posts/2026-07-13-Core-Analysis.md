...
This is a component that outputs the code information generated by the Core component as a text log, including robot axis angle values, the error index, and the error reason.
...
| :--- | :--- | :--- |
| **GERTY Solver** | GERTY Solver | Connect to <a href="https://batpartners.github.io/core/Core-Display-Solver/" target="_blank">GERTY Solver</a> |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| **RobAx Angles** | String | Robot axis angles |
| **Error Idx** | String | Error index |
| **Error Report** | String | Error type analysis by row |