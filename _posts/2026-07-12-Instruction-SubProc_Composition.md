...
translated: true
lang: ko
permalink: /instruction/Instruction-SubProc_Composition/

translation_link: /en/instruction/Instruction-SubProc_Composition/
sidebar:
  nav: "sidebar"
toc: true
toc_label: "Contents"
...
| 이름 | 타입 | 설명 |
| :--- | :--- | :--- |
| **Instruction** | Instruction | ABB 인스트럭션. |
...
<p align="center"><img src="/assets/images/8_SubProcedure_10.png" align="center" width="45%"></p>
  </div>
</div>
...
| 이름 | 타입 | 설명 |
| :--- | :--- | :--- |
| **SubProc** | SubProc | 생성된 프로시저. Core 컴포넌트의 Instructions 입력으로 전달 |
