...
Positioner Robtarget은 포지셔너(외부축) 회전각을 포함하고 있는 Robtarget 컴포넌트이다. 컴포넌트 아이콘을 우클릭하여 Dynamic, Static 모드로 전환해 사용이 가능하다.
...
| WobjData | WobjData | <a href="https://batpartners.github.io/datatype/DataType-WobjData/" target="_blank">ABB 작업 평면 좌표계</a>를 기준으로 Target Plane 재정. (선택) |
