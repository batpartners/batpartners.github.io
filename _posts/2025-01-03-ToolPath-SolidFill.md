...
translated: true
lang: ko
permalink: /toolpath/ToolPath-SolidFill/

translation_link: /en/toolpath/ToolPath-SolidFill/
sidebar:
  nav: "sidebar"
toc: true
toc_label: "Contents"
    ...
    <table class="spec-table">
      ...
      <tbody>
        <tr>
          ...
          <td>String</td>
          <td>내부 채움 영역에 적용할 패턴.</td>
        </tr>
        <tr>
          <td><strong>External Infill Type</strong></td>
          <td>String</td>
          <td>외부 채움 영역에 적용할 패턴.</td>
        </tr>
        <tr>
          <td><strong>Rotation</strong></td>
          <td>Number</td>
          <td>채움 패턴에 적용할 회전 각도.</td>
        </tr>
      </tbody>
    </table>
    <p align="center">  <img src="/assets/images/10_SolidFill_10.png" align="center" width="32%"></p>
  </div>
    ...
    <table class="spec-table">
      ...
      <tbody>
        <tr>
          ...
          <td>Integer</td>
          <td>파트 상단에 생성할 솔리드 레이어 수.</td>
        </tr>
        <tr>
          <td><strong>Bottom Layers</strong></td>
          <td>Integer</td>
          <td>파트 하단에 생성할 솔리드 레이어 수.</td>
        </tr>
        <tr>
          <td><strong>Fill Gap</strong></td>
          <td>Number</td>
          <td>외곽과 채움, 내부 채움과 외부 채움 패턴 사이의 간격 (mm).</td>
        </tr>
        <tr>
          <td><strong>Int-Infill Amount</strong></td>
          <td>Number</td>
          <td>내부 채움 밀도 (0~1, 0%~100%).</td>
        </tr>
      </tbody>
    </table>
    <br>
    <p align="center">  <img src="/assets/images/10_SolidFill_11.png" align="center" width="32%"></p>
  </div>
</div>
...
| 이름 | 타입 | 설명 |
| :--- | :--- | :--- |
| **Infill ToolPaths** | Infill ToolPaths Tree | 생성된 적층 경로 데이터. |
| **Infill Pattern** | Curve | 생성된 채움 적층 경로를 연결하는 폴리라인 패턴. |