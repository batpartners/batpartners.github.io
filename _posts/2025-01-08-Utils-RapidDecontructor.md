...
translated: true
lang: ko
permalink: /utils/Utils-RapidDecontructor/

translation_link: /en/utils/Utils-RapidDecontructor/
sidebar:
  nav: "sidebar"
toc: true
toc_label: "Contents"
...
| 이름 | 타입 | 설명 |
| :--- | :--- | :--- |
| **ProgramData** | Data | ABB 프로그램 데이터 |
| **Instructions** | Instructions | ABB 명령 객체 |

# | 출력(Output)

| 이름 | 타입 | 설명 |
| :--- | :--- | :--- |
| **Data Str.** | String | 프로그램 데이터 소스 |
| **Instruction Str.** | String | 명령 데이터 소스 |
