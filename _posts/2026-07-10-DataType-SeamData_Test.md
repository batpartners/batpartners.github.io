...
translated: true
lang: ko
permalink: /datatype/DataType-SeamData_Test/
    ...
    <table class="spec-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Boolean</td>
          <td>모든 단계(Ignition, Heat, End)의 ArcData 값을 연동할지 여부를 설정한다.<br><ul><li><strong>TRUE:</strong> 한 단계의 값을 조절하면 나머지 단계도 동일한 값으로 동기화된다.</li><li><strong>FALSE:</strong> 각 단계를 독립적으로 조절할 수 있다(기본값).</li></ul></td>
        </tr>
      </tbody>
    </table>
