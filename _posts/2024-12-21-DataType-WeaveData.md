    ...
    <table class="spec-table" style="margin: 0;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>String</td>
          <td>위빙 패턴 모양.<br>
          [0]: 없음, [1]: 지그재그(수평), [2]: V형(수직), [3]: 삼각형(수직), [4]: 원형(수직)</td>
        </tr>
        <tr>
    ...
    <table class="spec-table" style="margin: 0;">
      ...
      <tbody>
        <tr>
          ...
          <td>Number</td>
          <td>T심에 수평인 평면에서 위빙패턴의 회전 각도 (°). 위에서 본 회전. 0°일 때 심에 수직.</td>
        </tr>
        <tr>
          <td><strong>Tilt Angle(°)</strong></td>
          <td>Number</td>
          <td>심에 수직인 평면에서 기울기 각도 (°). 옆에서 본 기울기. 0°일 때 완전 수직.</td>
        </tr>
        <tr>
          <td><strong>Orient Angle(°)</strong></td>
          <td>Number</td>
          <td>정면에서 본 수평-수직 방향성 각도 (°). 0°일 때 좌우 대칭. 비대칭 V/삼각형 패턴에 유용.</td>
        </tr>
      </tbody>
    </table>
    <br>
