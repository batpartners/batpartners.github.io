...
layout: single
header:
  teaser: "/assets/images/6_PathAccLim.png"
    ...
    <table class="spec-table">
      ...
      <tbody>
        <tr>
          ...
          <td>Toggle</td>
          <td>로봇 가속 제한 설정(True : 제한, False : 제한 안함)</td>
        </tr>
        <tr>
          <td><strong>DecelLim</strong></td>
          <td>Toggle</td>
          <td>로봇 감속 제한 설정(True : 제한, False : 제안 안함)</td>
        </tr>
        <tr>
          <td><strong>AccMax(m/s²)</strong></td>
          <td>Number</td>
          <td>로봇 최대 가속도 설정(AccLim이 True일 경우 유효)</td>
        </tr>
        <tr>
          <td><strong>DecelMax(m/s²)</strong></td>
          <td>Number</td>
          <td>로봇 최대 감속도 설정(DecelLim이 True일 경우 유효)</td>
        </tr>        
      </tbody>
    </table>
<p align="center"><img src="/assets/images/6_PathAccLim_1.png" align="center" width="45%"></p>
  </div>
</div>
