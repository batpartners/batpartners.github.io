...
데이터 타입은 **String**이다. 사용자가 정의한 변수값을 설정하는데 주로 사용되며, <a href="https://batpartners.github.io/robottool/core/Core-Code-Solver/" target="_blank">*Code Solver*</a>의 경우 저장되는 파일명과 프로젝트 이름으로 작성된다.
