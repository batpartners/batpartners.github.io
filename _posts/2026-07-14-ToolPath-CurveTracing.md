...
translated: true
lang: ko
permalink: /toolpath/ToolPath-CurveTracing/

translation_link: /en/toolpath/ToolPath-CurveTracing/
sidebar:
  nav: "sidebar"
toc: true
toc_label: "Contents"
...
CurveTracing은 사용자가 정의한 커브를 트레이싱할 수 있는 로봇 툴패스 컴포넌트이다. 작업 평면의 정확도, 틸팅 정도를 설정할 수 있다.
    ...
    <table class="spec-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Number</td>
          <td>경로 세그먼트의 최소 길이 (mm)</td>
        </tr>
        <tr>
          <td><strong>MaxEdge</strong></td>
          <td>Number</td>
          <td>경로 세그먼트의 최대 길이 (mm)</td>
        </tr>
      </tbody>
    </table>
    <br>
